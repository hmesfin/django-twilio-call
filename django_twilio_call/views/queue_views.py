...
class QueueViewSet(BaseCallCenterViewSet):
    ...
    def statistics(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                ...
                message=f"Statistics retrieved for queue {queue.name}"
            )
    ...
    def activate(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                message=f"Queue {queue.name} activated successfully"
            )
        except QueueServiceError as e:
    ...
    def deactivate(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                message=f"Queue {queue.name} deactivated successfully"
            )
        except QueueServiceError as e:
    ...
    def metrics(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                data=metrics,
                message=f"Real-time metrics for queue {queue.name}"
            )
    ...
    def waiting_calls(self, request, public_id=None):
        ...
        try:
            ...
            for idx, call in enumerate(waiting_calls, 1):
                ...
                call_data['wait_time_seconds'] = (
                    call.queue_time if hasattr(call, 'queue_time') else 0
                )
    ...
    def clear_queue(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                data={"cleared_calls": cleared_count},
                message=f"Cleared {cleared_count} calls from queue {queue.name}"
            )
        except Exception as e:
    ...
    def update_priority(self, request, public_id=None):
        ...
        if new_priority is None:
            return self.handle_error(
                ValueError("priority is required"),
    ...
    def assign_agents(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                data=self.get_serializer(queue).data,
                message=f"Assigned {len(agents)} agents to queue {queue.name}"
            )
        except Exception as e:
    ...
    def remove_agents(self, request, public_id=None):
        ...
        try:
            ...
            return self.success_response(
                data=self.get_serializer(queue).data,
                message=f"Removed {len(agents)} agents from queue {queue.name}"
            )
        except Exception as e:
