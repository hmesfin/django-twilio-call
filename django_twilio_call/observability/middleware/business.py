...
class BusinessMetricsMiddleware(MiddlewareMixin):
    ...
    def _collect_business_metrics(self, request: HttpRequest, response: HttpResponse,
                                 context: Dict[str, Any], start_time: float) -> None:
        ...
        if self._is_webhook_endpoint(endpoint):
            ...
            self.webhook_processing.labels(
