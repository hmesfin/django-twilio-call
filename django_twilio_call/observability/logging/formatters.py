...
class StructuredJsonFormatter(jsonlogger.JsonFormatter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.base_fields = [
            'asctime', 'name', 'levelname', 'message', 'pathname',
            'lineno', 'funcName', 'process', 'thread'
        ]
...
class CallCenterLogger:
    ...
    def log_twilio_api_call(self, endpoint: str, method: str, duration_ms: float,
                           status_code: int, **context) -> None:
        """Log Twilio API call."""
        self._log(
            logging.INFO,
    ...
    def log_task_execution(self, task_id: str, task_name: str, status: str,
                          duration_ms: Optional[float] = None, **context) -> None:
        """Log task execution."""
    ...
    def log_webhook_processing(self, webhook_type: str, status: str,
    ...
    def log_performance_issue(self, component: str, metric: str, value: float,
