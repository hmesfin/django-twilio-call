...
def instrument_view(view_func: Callable) -> Callable:
    ...
    def wrapper(request: HttpRequest, *args, **kwargs) -> HttpResponse:
        ...
        try:
            ...
            # Log view execution
            logger.info(f"View executed: {view_name}", extra={
                'view_name': view_name,
            ...
            duration = time.time() - start_time
            logger.error(f"View failed: {view_name}", extra={
                'view_name': view_name,
                'method': request.method,
                'path': request.path,
                'duration_ms': duration * 1000,
...
def instrument_service_method(method_func: Callable) -> Callable:
    ...
    def wrapper(*args, **kwargs) -> Any:
        ...
        try:
            ...
            logger.info(f"Service method executed: {method_name}", extra={
            ...
            duration = time.time() - start_time
            logger.error(f"Service method failed: {method_name}", extra={
                'method_name': method_name,
                'duration_ms': duration * 1000,
                'error': str(e),
            })
...
def monitor_model_save(model_class: models.Model):
    ...
    def instrumented_save(self, *args, **kwargs):
        ...
        try:
            ...
            logger.debug(f"Model {operation}: {model_name}", extra={
            ...
            logger.error(f"Model {operation} failed: {model_name}", extra={
                'model_name': model_name,
                'operation': operation,
                'duration_ms': duration * 1000,
                'error': str(e),
...
class ObservabilityMixin:
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            logger.info(f"Class-based view executed: {view_name}", extra={
                'view_name': view_name,
                'method': request.method,
                'path': request.path,
                'status_code': response.status_code,
            ...
            duration = time.time() - start_time
            logger.error(f"Class-based view failed: {view_name}", extra={
                'view_name': view_name,
                'method': request.method,
                'path': request.path,
                'duration_ms': duration * 1000,
