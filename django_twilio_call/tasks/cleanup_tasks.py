        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                ...
                meta={
                    'current': 2,
                    'total': 3,
                    'status': f'Deleting {total_count} old call logs'
                }
            )
...
def archive_old_recordings(self, days_to_keep: int = None, archive_to_s3: bool = True):
    ...
    try:
        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                state='PROGRESS',
                meta={'current': 1, 'total': 5, 'status': 'Identifying old recordings'}
            )
        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                ...
                meta={
                    'current': 2,
                    'total': 5,
                    'status': f'Processing {total_count} recordings for archival'
                }
            )
        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                state='PROGRESS',
                meta={'current': 5, 'total': 5, 'status': 'Archival completed'}
            )
...
def cleanup_old_task_executions(self, days_to_keep: int = 30):
    ...
    try:
        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                state='PROGRESS',
                meta={'current': 1, 'total': 3, 'status': 'Identifying old task executions'}
            )
        ...
        if hasattr(self, 'update_state'):
            self.update_state(
                ...
                meta={
                    'current': 2,
                    'total': 3,
                    'status': f'Deleting {total_count} old task executions'
                }
            )
